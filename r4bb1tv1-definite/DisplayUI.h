...
const char D_SCANNING_0[] PROGMEM = "_____               ]";
const char D_SCANNING_1[] PROGMEM = "_________           ]";
const char D_SCANNING_2[] PROGMEM = "______________      ]";
const char D_SCANNING_3[] PROGMEM = "____________________]";
...
class DisplayUI {
    public:
        ...
        void drawBatteryIconWithPercentage();
        Button* up   = NULL;
        Button* down = NULL;
        Button* a    = NULL;
        Button* b    = NULL;
    ...
    private:
        ...
        int lastBatteryPercentage; // Variável para armazenar a última porcentagem da bateria
